                            ...
                            <div className="auth-card new-applicant-card">
                                ...
                                <div className="new-applicant-content" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '180px' }}>
                                    ...
                                    <div className="google-btn-wrapper">
                                         <button className="google-sign-in-btn" disabled={isLoading} style={{ gap: '10px' }}>
                                             {isLoading ? (
                                                 <>
                                                     <span className="btn-spinner" style={{ borderTopColor: '#4285F4', borderLeftColor: 'rgba(66, 133, 244, 0.25)', borderRightColor: 'rgba(66, 133, 244, 0.25)', borderBottomColor: 'rgba(66, 133, 244, 0.25)' }}></span>
