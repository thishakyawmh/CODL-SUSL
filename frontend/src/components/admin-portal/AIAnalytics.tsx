            ...
            {loading ? (
                ...
                <div className="ai-tab-content">
                    ...
                    {activeTab === 'industry' && industryData && (
                        <div className="space-y-6">
                            <div className="ai-kpi-card text-center py-4 rounded-lg">
                                <h4>Critical Industry Skill Shortages</h4>
                                <p className="text-slate-500 text-sm mb-3">Key technologies flagged in employer audits (mentioned in &gt; 20% of responses).</p>
                    ...
                    {activeTab === 'recommendations' && (
                        <div className="space-y-4">
                            <div className="p-4 bg-purple-50 border-l-4 border-purple-500 rounded-r-lg text-sm mb-2 text-purple-900">
                                            ...
                                            <div>
                                                ...
                                                <div className="flex gap-2 mt-2">
                                                    {rec.courses_lacking.map((c: any) => (
                                                        <span key={c.id} className="code-badge bg-red-100 text-red-700 border border-red-200">{c.title} ({c.code})</span>
                                                    ))}
                                                </div>
                                            </div>
                                        </div>
                    ...
                    {activeTab === 'surveys' && surveys && (
                        <div className="space-y-6">
                            <div className="ai-charts-grid">
                                <div className="ai-table-card">
                                    <div className="flex justify-between items-center mb-4 p-4 border-b border-slate-200">
